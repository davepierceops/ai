...
5. the role document for the role they are filling, including `roles/spec-reviewer-agent.md` for any chat involving spec authorship or review, and `roles/chief-of-staff.md` for any chat involving decomposing a spec into work packages
